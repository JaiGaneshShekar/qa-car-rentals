@regression
Feature: Seven days check has not been implemented in Book API
  Background:
  ...
  Scenario:
    ...
    And request {"car_id":"6098bafd1ff5990015be8e20","car_license_number":"#(license)","total_rent_bill":26800,"from_date_time":"2021-05-23","to_date_time":"2021-04-27"}
    When method POST
    Then status 200
