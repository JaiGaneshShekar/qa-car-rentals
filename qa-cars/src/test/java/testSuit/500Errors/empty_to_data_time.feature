...
Feature: Priority High
  Scenario: If to_date_time field is passed as an empty string in the book api, 500 error
    ...
    * def authToken = response.response.authToken
    ...
    And request {"car_id":"6098bafd1ff5990015be8e20","car_license_number":"KA01EM1000","total_rent_bill":19350,"from_date_time":"0002-01-23","to_date_time":""}
    When method POST
    Then status 500
